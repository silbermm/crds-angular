describe('GiveController', function() {
  ...
  var $controller, $rootScope, $scope, $state, $timeout, $httpProvider, Session, Profile, programList;
  ...
  beforeEach(inject(function($injector){
    ...
    Profile = $injector.get('Profile');
  	$controller = $controller('GiveCtrl', { '$rootScope': $rootScope, '$scope': $scope, '$state': $state, '$timeout': $timeout,
   		'$httpProvider': $httpProvider, 'Session': Session, 'Profile': Profile, 'programList':programList });
  }));
