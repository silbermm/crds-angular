(function() {
  ...
  module.exports = SignupPage2Service;

  //SignupPage2Service.$inject = ['$rootScope', 'Session', 'GiveTransferService', 'PaymentService', 'GiveFlow', '$state', 'CC_BRAND_CODES'];

  function SignupPage2Service() {
    var signupPage2Service = {
      page2: {},
      setPage2: setPage2
    ...
    function setPage2(input) {
      signupPage2Service.page2.guardianFirstName = getValue(input.guardianFirstName);
      signupPage2Service.page2.guardianLastName = getValue(input.guardianLastName);
      signupPage2Service.page2.tshirtSize = getValue(input.tshirtSize);
    }
