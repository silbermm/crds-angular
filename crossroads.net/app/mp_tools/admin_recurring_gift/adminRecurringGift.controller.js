(function() {
  ...
  AdminRecurringGiftController.$inject = ['$state', 'MPTools', 'GivingHistoryService', 'AuthService', 'GIVE_ROLES'];

  function AdminRecurringGiftController($state, MPTools, GivingHistoryService, AuthService, GIVE_ROLES) {
    var vm = this;
