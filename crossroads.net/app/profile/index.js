...
app.factory('ProfileReferenceData', ['Lookup', 'Profile', require('./services/profile_reference_data')]);
...
app.directive('profilePersonal', ["$http", "$log", "$controller", "Session", "User", require("./personal/profile_personal.directive")]);
