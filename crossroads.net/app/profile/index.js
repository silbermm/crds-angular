...
app.factory('ProfileReferenceData', ['Lookup', 'Profile', '$resolve', '$q', require('./services/profile_reference_data')]);
...
app.directive('profilePersonal', ["$http", "$log", "$resolve", "$q", "Session", "User", "ProfileReferenceData", require("./personal/profile_personal.directive")]);
