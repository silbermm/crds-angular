'use strict()';
(function () {
  module.exports = SuperbowlCtrl;

  SuperbowlCtrl.$inject = ['$state', '$modal'];

  function SuperbowlCtrl($state, $modal) {
    var vm = this;
