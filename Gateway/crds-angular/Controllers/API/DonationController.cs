    ...
    public class DonationController : MPAuth
    {
        ...
        private IHttpActionResult CreateDonationAndDistributionAuthenticated(String token, CreateDonationDTO dto)
        {
            try{
                ...
                var donationId = mpDonorService.CreateDonationAndDistributionRecord(dto.amount, donor.DonorId, dto.program_id, charge_id, dto.pymt_type, DateTime.Now, true);
        ...
        private IHttpActionResult CreateDonationAndDistributionUnauthenticated(CreateDonationDTO dto)
        {
            try
            {
                ...
                var charge_id = stripeService.chargeCustomer(donor.ProcessorId, dto.amount, donor.DonorId, dto.pymt_type);
                var donationId = mpDonorService.CreateDonationAndDistributionRecord(dto.amount, donor.DonorId, dto.program_id, charge_id, dto.pymt_type, DateTime.Now, false);
