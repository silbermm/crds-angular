...
Set @contactID = (select top 1 contact_id from contacts where email_address = 'mpcrds+echeckinhus@gmail.com' and last_name = 'ECheckIn');
...
WHERE email_address = 'mpcrds+echeckinhus@gmail.com' and last_name = 'ECheckIn';
...
--Delete all donations for EcheckInHusband's trip pledge program.
...
--Delete all of EcheckInHusband's donations.
...
--Delete userAccount
delete from dp_user_roles where user_id = (select user_id from dp_users where user_email = 'mpcrds+echeckinhus@gmail.com');

delete from dp_users where user_email = 'mpcrds+echeckinhus@gmail.com';

--Delete EcheckInHusband's old contact record
DELETE FROM [dbo].Contacts where contact_id = (select top 1 contact_id from contacts where email_address = 'mpcrds+echeckinhus@gmail.com' and last_name = 'ECheckIn');
GO