...
Set @contactID = (select contact_id from contacts where email_address = 'mpcrds+echeckinhus@gmail.com' and last_name = 'ECheckIn');
...
DELETE FROM [dbo].Contacts where email_address = 'mpcrds+echeckinhus@gmail.com' and last_name = 'ECheckIn';
GO