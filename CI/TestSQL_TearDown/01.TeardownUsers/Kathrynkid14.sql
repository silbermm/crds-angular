...
Set @contactID = (select top 1 contact_id from contacts where email_address = 'kcradduck+kid14@crossroads.net' and last_name = 'Cradduck-Test');
...
DELETE FROM [dbo].Contacts where contact_id = (select top 1 contact_id from contacts where email_address = 'kcradduck+kid14@crossroads.net' and last_name = 'Cradduck-Test');
GO