...
WHERE email_address = 'mpcrds+PCHead1@gmail.com' and last_name = 'HeadofHousehold1';
...
--Just get rid of this so we can delete PCHead1's old contact record
...
--Delete all donations for PCHead1's trip pledge program. This is custom for PCHead1's teardown script.
...
--Delete all of PCHead1's donations.
