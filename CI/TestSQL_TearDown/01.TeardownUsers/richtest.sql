...
WHERE email_address = 'rtheil+testing@crossroads.net' and last_name = 'Theil-Test';
...
--Delete all donations for Rich's trip pledge program.
...
--Delete all of Rich's donations.
...
--Delete userAccount
delete from dp_user_roles where user_id = (select user_id from dp_users where user_email = 'rtheil+testing@crossroads.net');
