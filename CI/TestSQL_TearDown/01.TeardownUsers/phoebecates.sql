...
Set @contactID = (select contact_id from contacts where email_address = 'mpcrds+6@gmail.com' and last_name = 'Cates');
...
DELETE FROM [dbo].Contacts where email_address = 'mpcrds+6@gmail.com' and last_name = 'Cates';
GO