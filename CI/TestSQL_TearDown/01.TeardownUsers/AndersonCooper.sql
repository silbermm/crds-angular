...
WHERE email_address = 'mpcrds+12@gmail.com' and last_name = 'Cooper';


--Just get rid of this so we can delete Anderson's old contact record
...
--Delete all donations for Anderson's trip pledge program.
...
--Delete all of Anderson's donations.
...
--Delete userAccount
delete from dp_user_roles where user_id = (select user_id from dp_users where user_email = 'mpcrds+12@gmail.com');
