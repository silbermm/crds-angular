...
WHILE EXISTS (SELECT * FROM contacts WHERE email_address = 'mpcrds+PCHead2@gmail.com')
BEGIN
--Get the required data to add to our contact. 
Declare @contactID as int
Set @contactID = (select top 1 contact_id from contacts where email_address = 'mpcrds+PCHead2@gmail.com' and last_name = 'HeadofHousehold2');
...
WHERE email_address = 'mpcrds+PCHead2@gmail.com' and last_name = 'HeadofHousehold2';
...
--Just get rid of this so we can delete PCHead2's old contact record
...
--Delete all donations for PCHead2's trip pledge program. This is custom for PCHead2's teardown script.
...
--Delete all of PCHead2's donations.
...
--Delete userAccount
delete from dp_user_roles where user_id = (select user_id from dp_users where user_email = 'mpcrds+PCHead2@gmail.com');

delete from dp_process_steps where Specific_user = (select user_id from dp_users where user_email = 'mpcrds+PCHead2@gmail.com');

delete from dp_users where user_email = 'mpcrds+PCHead2@gmail.com';

--Delete PCHead2's old contact record
DELETE FROM [dbo].Contacts where contact_id = (select top 1 contact_id from contacts where email_address = 'mpcrds+PCHead2@gmail.com' and last_name = 'HeadofHousehold2');
END