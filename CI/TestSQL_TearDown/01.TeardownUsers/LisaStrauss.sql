...
Set @contactID = (select top 1 contact_id from contacts where email_address = 'mpcrds+15@gmail.com' and last_name = 'Strauss');
...
WHERE email_address = 'mpcrds+15@gmail.com' and last_name = 'Strauss';
...
--Just get rid of this so we can delete Lisa's old contact record
...
--Delete all donations for Lisa's trip pledge program.
...
--Delete all of Lisa's donations.
...
--Delete userAccount
delete from dp_user_roles where user_id = (select user_id from dp_users where user_email = 'mpcrds+15@gmail.com');

delete from dp_users where user_email = 'mpcrds+15@gmail.com';

--Delete Lisa's old contact record
DELETE FROM [dbo].Contacts where contact_id = (select top 1 contact_id from contacts where email_address = 'mpcrds+15@gmail.com' and last_name = 'Strauss');
GO