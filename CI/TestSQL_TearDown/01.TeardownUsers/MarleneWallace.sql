...
Set @contactID = (select top 1 contact_id from contacts where email_address = 'mpcrds+marlenewallace@gmail.com' and last_name = 'Wallace');
...
--Delete all donations for Marlene's trip pledge program.
...
--Delete all of Marlene's donations.
...
--Delete userAccount
delete from dp_user_roles where user_id = (select user_id from dp_users where user_email = 'mpcrds+marlenewallace@gmail.com');

delete from dp_users where user_email = 'mpcrds+marlenewallace@gmail.com';

--Delete Marlene's old contact record
DELETE FROM [dbo].Contacts where contact_id = (select top 1 contact_id from contacts where email_address = 'mpcrds+marlenewallace@gmail.com' and last_name = 'Wallace');
GO