...
Set @contactID = (select top 1 contact_id from contacts where email_address = 'kidsclubmom@gmail.com' and last_name = 'KidsClubAppFam');
...
WHERE email_address = 'kidsclubmom@gmail.com' and last_name = 'KidsClubAppFam';
...
--Just get rid of this so we can delete KidsClubMom's old contact record
...
--Delete all donations for KidClubMom's trip pledge program.
...
--Delete all of KidsClubMom's donations.
...
--Delete userAccount
delete from dp_user_roles where user_id = (select user_id from dp_users where user_email = 'kidsclubmom@gmail.com');

delete from dp_users where user_email = 'kidsclubmom@gmail.com';

--Delete KidsClubMom's old contact record
DELETE FROM [dbo].Contacts where contact_id = (select top 1 contact_id from contacts where email_address = 'kidsclubmom@gmail.com' and last_name = 'KidsClubAppFam');
GO