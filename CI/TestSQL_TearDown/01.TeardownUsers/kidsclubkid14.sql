...
Set @contactID = (select top 1 contact_id from contacts where email_address = 'kidsclubkid14@gmail.com' and last_name = 'KidsClubAppFam');
...
WHERE email_address = 'kidsclubkid14@gmail.com' and last_name = 'KidsClubAppFam';
...
--Delete userAccount
delete from dp_user_roles where user_id = (select user_id from dp_users where user_email = 'kidsclubkid14@gmail.com');

delete from dp_users where user_email = 'kidsclubkid14@gmail.com';

--Delete Kid14's old contact record
DELETE FROM [dbo].Contacts where contact_id = (select top 1 contact_id from contacts where email_address = 'kidsclubkid14@gmail.com' and last_name = 'KidsClubAppFam');
GO