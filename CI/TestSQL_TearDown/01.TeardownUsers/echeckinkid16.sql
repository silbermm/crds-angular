...
Set @contactID = (select contact_id from contacts where email_address = display_name = 'ECheckIn, Kid16');
...
WHERE email_address = display_name = 'ECheckIn, Kid16';
...
DELETE FROM [dbo].Contacts where email_address = display_name = 'ECheckIn, Kid16';
GO