...
Set @contactID = (select top 1 contact_id from contacts where email_address = 'mpcrds+echeckinwif@gmail.com' and last_name = 'ECheckIn');
...
DELETE FROM [dbo].Contacts where contact_id = (select top 1 contact_id from contacts where email_address = 'mpcrds+echeckinwif@gmail.com' and last_name = 'ECheckIn');
GO