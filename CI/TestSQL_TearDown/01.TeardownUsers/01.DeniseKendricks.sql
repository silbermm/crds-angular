...
WHERE email_address = 'mpcrds+20@gmail.com' and last_name = 'Kendricks';
...
DELETE FROM [dbo].Contacts where email_address = 'mpcrds+20@gmail.com' and last_name = 'Kendricks';
GO