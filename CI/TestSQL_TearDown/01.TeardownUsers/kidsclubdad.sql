...
Set @contactID = (select top 1 contact_id from contacts where email_address = 'kidsclubdad@gmail.com' and last_name = 'KidsClubAppFam');
...
WHERE email_address = 'kidsclubdad@gmail.com' and last_name = 'KidsClubAppFam';
...
--Just get rid of this so we can delete KidsClubDad's old contact record
...
--Delete all donations for KidClubDad's trip pledge program.
...
--Delete all of KidsClubDad's donations.
...
--Delete userAccount
delete from dp_user_roles where user_id = (select user_id from dp_users where user_email = 'kidsclubdad@gmail.com');

delete from dp_users where user_email = 'kidsclubdad@gmail.com';

--Delete KidsClubDad's old contact record
DELETE FROM [dbo].Contacts where contact_id = (select top 1 contact_id from contacts where email_address = 'kidsclubdad@gmail.com' and last_name = 'KidsClubAppFam');
GO