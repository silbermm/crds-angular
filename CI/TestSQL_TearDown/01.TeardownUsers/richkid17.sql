...
Set @contactID = (select top 1 contact_id from contacts where email_address = 'rtheil+kid17@crossroads.net' and last_name = 'Theil-Test');
...
WHERE email_address = 'rtheil+kid17@crossroads.net' and last_name = 'Theil-Test';
...
--Delete userAccount
delete from dp_user_roles where user_id = (select user_id from dp_users where user_email = 'rtheil+kid17@crossroads.net');

delete from dp_users where user_email = 'rtheil+kid17@crossroads.net';

--Delete Kid17's old contact record
DELETE FROM [dbo].Contacts where contact_id = (select top 1 contact_id from contacts where email_address = 'rtheil+kid17@crossroads.net' and last_name = 'Theil-Test');
GO