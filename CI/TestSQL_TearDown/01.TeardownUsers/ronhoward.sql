...
Set @contactID = (select top 1 contact_id from contacts where email_address = 'mpcrds+8@gmail.com' and last_name = 'Howard');
...
WHERE email_address = 'mpcrds+8@gmail.com' and last_name = 'Howard';
...
--Just get rid of this so we can delete Ron's old contact record
...
--Delete all donations for Ron's trip pledge program.
...
--Delete userAccount
delete from dp_user_roles where user_id = (select user_id from dp_users where user_email = 'mpcrds+8@gmail.com');

delete from dp_users where user_email = 'mpcrds+8@gmail.com';

--Delete Ron's old contact record
DELETE FROM [dbo].Contacts where contact_id = (select top 1 contact_id from contacts where email_address = 'mpcrds+8@gmail.com' and last_name = 'Howard');
GO