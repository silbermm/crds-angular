...
Set @contactID = (select contact_id from contacts where email_address = 'mpcrds+8@gmail.com' and last_name = 'Howard');
...
DELETE FROM [dbo].Contacts where email_address = 'mpcrds+8@gmail.com' and last_name = 'Howard';
GO