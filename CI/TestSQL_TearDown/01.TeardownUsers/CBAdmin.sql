...
Set @contactID = (select top 1 contact_id from contacts where email_address = 'mpcrds+cbadmin@gmail.com' and last_name = 'CorkboardAdmin');
...
WHERE email_address = 'mpcrds+cbadmin@gmail.com' and last_name = 'CorkboardAdmin';


--Just get rid of this so we can delete CBAdmin's old contact record
...
--Delete all donations for CBAdmin's trip pledge program.
...
--Delete all of CBAdmin's donations.
...
--Delete userAccount
delete from dp_user_roles where user_id = (select user_id from dp_users where user_email = 'mpcrds+cbadmin@gmail.com');

delete from dp_users where user_email = 'mpcrds+cbadmin@gmail.com';

--Delete CBAdmin's old contact record
DELETE FROM [dbo].Contacts where contact_id = (select top 1 contact_id from contacts where email_address = 'mpcrds+cbadmin@gmail.com' and last_name = 'CorkboardAdmin');
GO