...
(@contactID,0      ,null        ,'KidsClubAppFam, DadJokes',1        ,'Dad'     ,'Jokes'    ,'KidsClubAppFam',null     ,'DadJokes',{d '1964-01-01'},1        ,2                ,1                ,@houseHoldID,1                    ,null              ,null        ,'kidsclubdad@gmail.com',null          ,0                 ,0               ,'123-654-8745',null          ,null                 ,'555-365-4125',null       ,null     ,null        ,null    ,null                 ,null       ,null         ,null         ,null     ,null            ,null              ,null          ,'313257D2-FAF6-40C1-BCB2-415DD4B43DAA',null   ,1        ,null      ,null                 ,null              ,null            ,null                ,null       ,null             ,null            ,null          ,null                );
...
(@userID,'kidsclubdad@gmail.com','kidsclubdad@gmail.com','KCDad'     ,CAST('welcome' as binary(16)),0    ,1        ,0                   ,2562427   ,null      ,'1A604096-0D1A-48B4-AE29-1BDED8557AD7',null           ,null       ,null     ,null  ,null ,0          ,null              ,null            ,null                    ,0             ,0               ,0               ,0               );
...
INSERT INTO [dbo].Contacts 
(Contact_ID,Company,Company_Name,Display_Name           ,Prefix_ID,First_Name,Middle_Name,Last_Name       ,Suffix_ID,Nickname,Date_of_Birth   ,Gender_ID,Marital_Status_ID,Contact_Status_ID,Household_ID,Household_Position_ID,Participant_Record,Donor_Record,Email_Address          ,Email_Unlisted,Bulk_Email_Opt_Out,Bulk_SMS_Opt_Out,Mobile_Phone  ,Mobile_Carrier,Mobile_Phone_Unlisted,Company_Phone,Pager_Phone,Fax_Phone,User_Account,Web_Page,Remove_From_Directory,Industry_ID,Occupation_ID,Employer_Name,[SSN/EIN],Anniversary_Date,HS_Graduation_Year,Current_School,Contact_GUID                          ,ID_Card,Domain_ID,__ShelbyID,__ExternalHouseholdID,__ExternalPersonID,__ExternalUserID,__ExternalBusinessID,Maiden_Name,__LastLegacyLogin,__LegacyUserName,__LegacyUserID,__LegacyEmailAddress) VALUES
(@contactID,0      ,null        ,'KidsClubAppFam, Momma',2        ,'Mom'     ,'A'        ,'KidsClubAppFam',null     ,'Momma' ,{d '1965-01-01'},2        ,2                ,1                ,@houseHoldID,1                    ,null              ,null        ,'kidsclubmom@gmail.com',null          ,0                 ,0               ,'321-654-8184',null          ,null                 ,null         ,null       ,null     ,null        ,null    ,null                 ,null       ,null         ,null         ,null     ,null            ,null              ,null          ,'C2DBAAF1-F31C-4CFA-AD73-C8A5F8A1E487',null   ,1        ,null      ,null                 ,null              ,null            ,null                ,null       ,null             ,null            ,null          ,null                );
...
INSERT INTO [dbo].Contacts 
(Contact_ID,Company,Company_Name,Display_Name                   ,Prefix_ID,First_Name     ,Middle_Name,Last_Name       ,Suffix_ID,Nickname       ,Date_of_Birth   ,Gender_ID,Marital_Status_ID,Contact_Status_ID,Household_ID,Household_Position_ID,Participant_Record,Donor_Record,Email_Address            ,Email_Unlisted,Bulk_Email_Opt_Out,Bulk_SMS_Opt_Out,Mobile_Phone  ,Mobile_Carrier,Mobile_Phone_Unlisted,Company_Phone,Pager_Phone,Fax_Phone,User_Account,Web_Page,Remove_From_Directory,Industry_ID,Occupation_ID,Employer_Name,[SSN/EIN],Anniversary_Date,HS_Graduation_Year,Current_School,Contact_GUID                          ,ID_Card,Domain_ID,__ShelbyID,__ExternalHouseholdID,__ExternalPersonID,__ExternalUserID,__ExternalBusinessID,Maiden_Name,__LastLegacyLogin,__LegacyUserName,__LegacyUserID,__LegacyEmailAddress) VALUES
(@contactID,0      ,null        ,'KidsClubAppFam, Billy the Kid',null     ,'KidsClubKid14',null       ,'KidsClubAppFam',null     ,'Billy the Kid',{d '2001-01-01'},2        ,1                ,1                ,@houseHoldID,2                    ,null              ,null        ,'kidsclubkid14@gmail.com',null          ,0                 ,0               ,'321-548-6154',null          ,null                 ,null         ,null       ,null     ,null        ,null    ,null                 ,null       ,null         ,null         ,null     ,null            ,null              ,null          ,'1BE16C39-792C-4F36-BF7B-9494F384CBC9',null   ,1        ,null      ,null                 ,null              ,null            ,null                ,null       ,null             ,null            ,null          ,null                );
...
INSERT INTO [dbo].dp_users 
(User_ID,User_Name                ,User_Email               ,Display_Name,Password                     ,Admin,Domain_ID,Publications_Manager,Contact_ID,Supervisor,User_GUID                             ,Can_Impersonate,In_Recovery,Time_Zone,Locale,Theme,Setup_Admin,__ExternalPersonID,__ExternalUserID,Data_Service_Permissions,Read_Permitted,Create_Permitted,Update_Permitted,Delete_Permitted) VALUES
(@userID,'kidsclubkid14@gmail.com','kidsclubkid14@gmail.com','KCKid14'   ,CAST('welcome' as binary(16)),0    ,1        ,0                   ,@contactID,null      ,'CA7EAA53-B07F-4D47-AD0B-98909382F4C7',null           ,null       ,null     ,null  ,null ,0          ,null              ,null            ,null                    ,0             ,0               ,0               ,0           );
...
INSERT INTO [dbo].Contacts 
(Contact_ID,Company,Company_Name,Display_Name                ,Prefix_ID,First_Name  ,Middle_Name,Last_Name       ,Suffix_ID,Nickname    ,Date_of_Birth   ,Gender_ID,Marital_Status_ID,Contact_Status_ID,Household_ID,Household_Position_ID,Participant_Record,Donor_Record,Email_Address            ,Email_Unlisted,Bulk_Email_Opt_Out,Bulk_SMS_Opt_Out,Mobile_Phone  ,Mobile_Carrier,Mobile_Phone_Unlisted,Company_Phone,Pager_Phone,Fax_Phone,User_Account,Web_Page,Remove_From_Directory,Industry_ID,Occupation_ID,Employer_Name,[SSN/EIN],Anniversary_Date,HS_Graduation_Year,Current_School,Contact_GUID                          ,ID_Card,Domain_ID,__ShelbyID,__ExternalHouseholdID,__ExternalPersonID,__ExternalUserID,__ExternalBusinessID,Maiden_Name,__LastLegacyLogin,__LegacyUserName,__LegacyUserID,__LegacyEmailAddress) VALUES
(@contactID,0      ,null        ,'KidsClubAppFam, kidsclub17',null     ,'kidsclub17','D'        ,'KidsClubAppFam',null     ,'kidsclub17',{d '1998-01-01'},null     ,1                ,1                ,@houseHoldID,4                    ,null              ,null        ,'kidsclubkid17@gmail.com',null          ,0                 ,0               ,'654-818-1425',null          ,null                 ,null         ,null       ,null     ,null        ,null    ,null                 ,null       ,null         ,null         ,null     ,null            ,null              ,null          ,'DE1393D7-E596-4D4A-819B-A8A22E29B00D',null   ,1        ,null      ,null                 ,null              ,null            ,null                ,null       ,null             ,null            ,null          ,null                );
