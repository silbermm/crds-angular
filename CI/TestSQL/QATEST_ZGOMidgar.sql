...
(@tripName ,5            ,20         ,5              ,2562378        ,null         ,CAST(@startYear as smalldatetime),CAST(@endYear as smalldatetime),null       ,null        ,null       ,null               ,null                   ,null                   ,0            ,null            ,null         ,null          ,null        ,null          ,null          ,null        ,1        ,null                ,0                ,null            ,0                 ,null                ,null                 ,null            ,null                    ,null          ,null             ,null                   ,null      ,null           ,null          ,null       ,null            ,null                      );
...
(@tripName  ,6            ,5              ,null       ,null                ,null       ,(select program_id from programs where program_name = @tripName),2562378         ,null                 ,0                ,CAST(@tripStart as smalldatetime),CAST(@endYear as smalldatetime),0                  ,0        ,1        ,null                   ,4                  ,0                   ,null                       ,null             ,null              ,null            ,null               ,1            ,null                  ,0               ,0                    ,0              ,null                   ,null                  ,null                   ,null           ,null       ,1        ,null              ,null                     ,0                     ,null             ,null                     ,null             ,null            ,null                   ,null        ,null             ,0            ,0            ,2                     );
GO
