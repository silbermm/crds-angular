...
(10000000          ,@tripName    ,'South Africa'  ,2                      ,'Church Mobilization - Midgar' ,5000.00      ,CAST(@startYear as smalldatetime),CAST(@tripStart as smalldatetime),1        ,null    ,null      ,null                ,CAST(@startYear as smalldatetime),CAST(@endYear as smalldatetime) ,null               ,17                  ,300.0000            ,0.0000          ,(select form_id from Forms where form_title = 'GO South Africa Application'),null                 ,1                  ,null                    ,0                     ,0                 ,40              ,99              );
