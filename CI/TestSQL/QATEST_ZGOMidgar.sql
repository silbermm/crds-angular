...
(@tripName ,5            ,20         ,5              ,768379         ,null         ,CAST(@startYear as smalldatetime),CAST(@endYear as smalldatetime),null       ,null        ,null       ,null               ,null                   ,null                   ,0            ,null            ,null         ,null          ,null        ,null          ,null          ,null        ,1        ,null                ,0                ,null            ,0                 ,null                ,null                 ,null            ,null                    ,null          ,null             ,null                   ,null      ,null           ,null          ,null       ,null            ,null                      );
...
--Insert large ID so we always know the id for this trip.
...
(10000000          ,@tripName    ,@tripname,2                      ,'Church Mobilization - Midgar' ,5000.00      ,CAST(@startYear as smalldatetime),CAST(@tripStart as smalldatetime),1        ,null    ,null      ,null                ,null              ,null            ,null               ,17                  ,340.0000            ,0.0000          ,(select form_id from Forms where form_title = 'GO South Africa Application'),null                 ,1                  ,null                    ,0                     ,0                 ,40              ,99              );
