...
(@householdID,'Gentry'      ,null      ,null      ,1        ,5              ,null       ,30                 ,null              ,null                 ,null               ,null                 ,0                ,null          ,null          ,null                 ,null                );
...
(@contactID,0      ,null        ,'Gentry, Gary' ,null     ,'Gary'    ,null       ,'Gentry' ,null     ,'Gary'  ,null         ,null     ,null             ,1                ,@householdID,1                    ,null              ,null        ,'mpcrds+16@gmail.com',null          ,0                 ,0               ,null        ,null          ,null                 ,null         ,null       ,null     ,null        ,null    ,null                 ,null       ,null         ,null         ,null     ,null            ,null              ,null          ,NEWID()     ,null   ,1        ,null      ,null                 ,null              ,null            ,null                ,null       ,null             ,null            ,null          ,null                );
...
(@user_id,'mpcrds+16@gmail.com','mpcrds+16@gmail.com','Gary'      ,CAST('welcome' as binary(16)),0    ,1        ,0                   ,@contactID,null      ,NEWID()                               ,null           ,null       ,null     ,null  ,null ,0          ,null              ,null            ,null                    ,0             ,0               ,0               ,0               );
...
(@donor_id,@contactID,1                     ,1                ,2                  ,{ts '2015-08-05 12:26:57.503'},null       ,null            ,null ,null              ,1        ,null              ,null                ,null               ,'cus_6nJJLwDL2q0clu');
