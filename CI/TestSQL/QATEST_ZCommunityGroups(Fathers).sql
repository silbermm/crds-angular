...
((select group_id from [dbo].groups where group_name = '(d) Fathers'' Group Mason') ,(select Participant_Record from [dbo].contacts where Email_Address = 'mpcrds+20@gmail.com') ,16           ,1        ,{ts '2015-07-29 12:06:50'},null    ,0            ,null          ,null ,null                       ,null                 ,null             ,null              ,null         ,null         ,null           ,null             ,null              ,null             ,null            );
