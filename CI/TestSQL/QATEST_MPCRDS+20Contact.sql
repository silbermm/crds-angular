...
(@contactID,0      ,null        ,'Guest Giver',null     ,null      ,null       ,null     ,null     ,'Guest Giver',null         ,null     ,null             ,1                ,null        ,1                    ,null              ,null        ,'mpcrds+20@gmail.com',null          ,0                 ,0               ,null        ,null          ,null                 ,null         ,null       ,null     ,null        ,null    ,null                 ,null       ,null         ,null         ,null     ,null            ,null              ,null          ,'6B51785E-77B3-4638-A2F4-1BB53CEB4BB0',null   ,1        ,null      ,null                 ,null              ,null            ,null                ,null       ,null             ,null            ,null          ,null                );
...
(@donor_id,@contactID,3                     ,1                ,4                  ,{ts '2015-07-06 12:03:37'},null       ,null            ,null ,null              ,1        ,null              ,null                ,null               ,'cus_6YjXxCzFsV300g');
...
INSERT INTO [dbo].Contacts 
(Contact_ID,Company,Company_Name,Display_Name      ,Prefix_ID,First_Name,Middle_Name,Last_Name  ,Suffix_ID,Nickname,Date_of_Birth,Gender_ID,Marital_Status_ID,Contact_Status_ID,Household_ID,Household_Position_ID,Participant_Record,Donor_Record,Email_Address        ,Email_Unlisted,Bulk_Email_Opt_Out,Bulk_SMS_Opt_Out,Mobile_Phone,Mobile_Carrier,Mobile_Phone_Unlisted,Company_Phone,Pager_Phone,Fax_Phone,User_Account,Web_Page,Remove_From_Directory,Industry_ID,Occupation_ID,Employer_Name,[SSN/EIN],Anniversary_Date,HS_Graduation_Year,Current_School,Contact_GUID                          ,ID_Card,Domain_ID,__ShelbyID,__ExternalHouseholdID,__ExternalPersonID,__ExternalUserID,__ExternalBusinessID,Maiden_Name,__LastLegacyLogin,__LegacyUserName,__LegacyUserID,__LegacyEmailAddress) VALUES
(@contactID,0      ,null        ,'Kendricks, Neece',null     ,'Denise'  ,null       ,'Kendricks',null     ,'Neece' ,null         ,null     ,null             ,1                ,@householdID,1                    ,null              ,null        ,'mpcrds+20@gmail.com',null          ,0                 ,0               ,null        ,null          ,null                 ,null         ,null       ,null     ,null        ,null    ,null                 ,null       ,null         ,null         ,null     ,null            ,null              ,null          ,'E6F88658-B825-4DBC-8D37-72DF6FC834FC',null   ,1        ,null      ,null                 ,null              ,null            ,null                ,null       ,null             ,null            ,null          ,null                );
...
(@user_id,'mpcrds+20@gmail.com','mpcrds+20@gmail.com','Denise'    ,CAST('welcome' as binary(16)) ,0    ,1        ,0                   ,@contactID,null      ,'2148C9F8-60FF-4810-8C92-18B3A00C62A0',null           ,null       ,null     ,null  ,null ,0          ,null              ,null            ,null                    ,0             ,0               ,0               ,0           );
...
INSERT INTO [dbo].Donors 
( Donor_ID,Contact_ID,Statement_Frequency_ID,Statement_Type_ID,Statement_Method_ID,Setup_Date                ,Envelope_No,Cancel_Envelopes,Notes,First_Contact_Made,Domain_ID,__ExternalPersonID,_First_Donation_Date,_Last_Donation_Date,Processor_ID        ) VALUES
(@donor_id,@contactID,1                     ,1                ,2                  ,{ts '2015-07-01 09:13:17'},null       ,null            ,null ,null              ,1        ,null              ,null                ,null               ,'cus_6Woe7iX2PlkGeb');
