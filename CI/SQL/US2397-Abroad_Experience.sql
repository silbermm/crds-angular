...
DECLARE @ATTRIBUTE_TYPE_ID int = 68;
DECLARE @ATTRIBUTE_TYPE_VALUE varchar(50) = N'Experience Abroad';
DECLARE @ATTRIBUTE_TYPE_DESCRIPTION varchar(255) = N'Experience outside of GO Trips';

DECLARE @ATTRIBUTE_ID_1 int = 3972;
DECLARE @ATTRIBUTE_NAME_1 varchar(100) = N'Experience Abroad';
