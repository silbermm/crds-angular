...
IF OBJECT_ID('dbo.crds_udfGetOrdinalNumber', 'TF') IS NULL
    EXEC('CREATE FUNCTION dbo.crds_udfGetOrdinalNumber(@InputNumber INT) RETURNS @OrdinalNumber VARCHAR AS BEGIN; RETURN; END')
GO
-- =============================================
-- Author:      Kriz, Jim
