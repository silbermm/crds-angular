...
CREATE TABLE [dbo].[tmp_ms_xx_Donations](
	...
	[Anonymous] [bit] NULL,
  [Check_Scanner_Batch] [nvarchar](50) NULL,
  ...
  [Reconcile_Change_Needed] [nvarchar](50) NULL,
	[Reconcile_Change_Complete] [bit] NULL,
...
IF EXISTS (SELECT TOP 1 1
    ...
    BEGIN
        ...
        [Reconcile_Change_Needed],
        [Reconcile_Change_Complete]
			)
        SELECT
				[Donation_ID],
				[Donor_ID],
