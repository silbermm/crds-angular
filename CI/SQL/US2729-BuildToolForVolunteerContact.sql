...
declare @ToolName varchar(30) = 'Volunteer Contact'
declare @LaunchPage varchar(100) = 'http://demo.crossroads.net/#/mptools/volunteer-contact'
declare @Description varchar(50) = 'Contact volunteers on your team'
declare @ToolId int

declare @PageToolAppearsOn int = 322 -- Groups Page
...
declare @ToolNameDev varchar(30) = 'Volunteer Contact - Development'
declare @LaunchPageDev varchar(100) = 'http://localhost:8080/#/mptools/volunteer-contact'
declare @DescriptionDev varchar(50) = 'Development Volunteer Contact'
