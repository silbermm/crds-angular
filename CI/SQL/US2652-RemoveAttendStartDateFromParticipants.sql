...
IF EXISTS(SELECT * FROM sys.columns 
           WHERE Name = N'Attend_Start_Date' AND Object_ID = Object_ID(N'Participants'))
BEGIN
   Alter table [dbo].[Participants] DROP COLUMN [Attend_Start_Date]
END


UPDATE [dbo].[dp_Pages] 
	SET Default_Field_List = N'Contact_ID_Table.Display_Name
