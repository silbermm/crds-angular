...
, Donation_Distributions.[Amount] AS [Amount]'
           ,'(Pledge_ID_Table_Pledge_Campaign_ID_Table_Event_ID_Table_Event_Type_ID_Table.[Event_Type_ID] = 6) AND (Donation_ID_Table_Donation_Status_ID_Table.[Display_On_MyTrips] = 1) AND (Pledge_ID_Table_Pledge_Campaign_ID_Table_Event_ID_Table.[Event_End_Date] <= DATEADD(day, 90, GETDATE()))')
GO