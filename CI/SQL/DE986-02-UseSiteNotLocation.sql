...
/****** Object:  StoredProcedure [dbo].[report_CRDS_Event_Setup_List]    Script Date: 1/26/2016 3:04:12 PM ******/
SET ANSI_NULLS ON
GO
...
AS
     BEGIN
      ...
      SELECT @ContactID = contact_id
	   ...
	   -- Location and Building are not being passed from the report now, so we
	   -- need to explicitly set them here, based on the "site" (congregation)
