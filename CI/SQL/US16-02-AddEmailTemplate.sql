...
SET 
   ...
   [Body] = '<p>Someone requested that the password be reset for the user with this email address on crossroads.net.</p><div><p>If this was a mistake, just ignore this email and nothing will happen.</p></div><div><p>Use this <a href="http://www.crossroads.net/lostpassword?[resetlink]">link</a> to reset your password http://www.crossroads.net/lostpassword?[resetlink]</p></div>',
   [Domain_ID] = 1,
